...
class TestCalculateTimesTotalPrice(unittest.TestCase):

    url = get_url('data', 'calculate_times_total_price', 'url')
    params = get_params('data', 'calculate_times_total_price', 'params')
    res = get_res('data', 'calculate_times_total_price', 'res')
