...
from base.base_action import get_url, get_res, now_time, start_log, runtime, end_log, params_log, res_log, \
    assert_equal, get_token, get_params, get_team_id, create_team, add_team_member, delete_team
from base.logger import Log


class TestDeleteTeamMember(unittest.TestCase):

    url = get_url('data', 'delete_team_member', 'url')
    params = get_params('data', 'delete_team_member', 'params')
    res = get_res('data', 'delete_team_member', 'res')
